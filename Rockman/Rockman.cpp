// ROCKMAN.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_ROCKMAN, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_ROCKMAN));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ROCKMAN));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYUP:
	{
		...
		{
		case 'X':
			KeyMgr::Get_Instance()->isdown = true;
			break;
		default:
			break;
		}
